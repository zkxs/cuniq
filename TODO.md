...
- ~~allow extra delimiters within a line?~~ Out of scope.
- ~~custom allocator?~~ Not needed: a better approach is to just avoid allocating
...
- statistical estimates
  ...
  - CVM (relatively new, very simple code, unclear if it is useful IRL beyond its simplicity to teach)
    - they claim "you don't need hashing" but then you have to do a ton of string equality checks instead? 
      I fail to see how that's better.
- ~~[Hashed Radix Sorting](https://reiner.org/hashed-sorting)~~
