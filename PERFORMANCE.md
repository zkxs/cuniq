...
| `cuniq --memmap --threads=1 huge.txt`                                                | 2.0.0     |     2m 47.462s | Count            | hashtable                            |       1 | Not sorting is cheaper than sorting, so this beats GNU sort easily.                                         |
| `cuniq --memmap huge.txt`                                                            | 2.0.0     |     2m 49.392s | Count            | hashtable                            |      16 | Bottleneck is in hashtable inserts, which cannot be multithreaded.                                          |
| `cuniq < huge.txt`                                                                   | 2.0.0     |     3m 28.081s | Count            | hashtable                            |       1 | stdin cannot not use memmap, and memmap is faster for large files                                           |
| `cuniq --memmap -c huge.txt > /dev/null`                                             | 2.0.0     | **3m 07.817s** | Report           | hashtable                            |       1 | Not sorting is cheaper than sorting, so this beats GNU sort easily.                                         |
| `cuniq --memmap -cs huge.txt > /dev/null`                                            | 2.0.0     | **3m 26.898s** | Report (sorted)  | hashtable                            |       1 | Sorting after dedupe is cheaper than sorting before dedupe, so this beats GNU sort easily.                  |
