...
| `sort -u huge.txt \| wc -l`                                                          | GNU 8.32  |                |             | Count            | sorting                              |       8 | Loses to dedicated tooling due to sorting the entire input.                                                 |
| `sort huge.txt \| uniq -c > /dev/null`                                               | GNU 8.32  |                |             | Report (sorted)  | sorting                              |       1 | Very bad. Better to use `awk` for reports if you are constrained to GNU coreutils.                          |
